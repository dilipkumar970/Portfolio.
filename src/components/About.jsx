  ...
  return (
    <>
      ...
      <p ref={paragraphRef} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        I'm a skilled software developer with experience in  Full stack development, and expertise in frameworks
        like React, Node.js, and Spring Boot. I'm a quick learner and collaborate closely with clients to create efficient,
